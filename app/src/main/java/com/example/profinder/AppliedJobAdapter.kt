...
class AppliedJobAdapter(private val dataList: ArrayList<AppliedJobDataClass>): RecyclerView.Adapter<AppliedJobAdapter.ViewHolderClass>() {
    ...
    class ViewHolderClass(itemView: View): RecyclerView.ViewHolder(itemView) {
        val rvLogo: ImageView = itemView.findViewById(R.id.applyCompanyLogo)
        ...
        val rvLastUpdated:TextView = itemView.findViewById(R.id.applyLastUpdated)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolderClass, position: Int) {
        ...
        holder.rvLogo.setImageResource(currentItem.adCompanyLogo)
        ...
        holder.rvLastUpdated.text = currentItem.adLastUpdated
    }
